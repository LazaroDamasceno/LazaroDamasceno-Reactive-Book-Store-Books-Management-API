...
public class BooksRetrieveController {
    ...
    @GetMapping("by-author/{author}/by-field/{field}/retrieving")
    @ResponseStatus(value = HttpStatus.OK)
    ...
    @GetMapping("by-author/{author}/by-year/{year}/retrieving")
    @ResponseStatus(value = HttpStatus.OK)
    ...
    @GetMapping("by-field/{field}/by-year/{year}/retrieving")
    @ResponseStatus(value = HttpStatus.OK)
